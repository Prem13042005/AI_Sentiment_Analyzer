...
import { register as registerApi, loginWithGoogle as loginWithGoogleApi, getErrorMessage } from '../services/api'
import Logo from '../components/Logo'
import { ShieldCheck, Brain, Zap, KeyRound, Mail, User } from 'lucide-react'
...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-bg select-none">
      ...
      {/* Left panel: Navy branding info (desktop) */}
      <div className="hidden lg:flex w-[40%] bg-navy flex-col justify-between p-12 text-white border-r border-[#162035]">
        <div>
          ...
          <p className="mt-4 text-sm text-text-muted leading-relaxed">
            Gain immediate access to deep learning sentiment pipelines and model explainability metrics.
          </p>
          ...
          <div className="mt-16 flex flex-col gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-text-muted mt-1 leading-relaxed">
                  Evaluate customer feedback using BiLSTM, GRU, CNN-LSTM, and DistilBERT.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-sm">Explainable Attributions</h4>
                <p className="text-xs text-text-muted mt-1 leading-relaxed">
                  Identify exact vocabulary impact on positive or negative scores with LIME models.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-sm">Enterprise Sandbox</h4>
                <p className="text-xs text-text-muted mt-1 leading-relaxed">
                  Upload CSV files up to 100 rows in size with high-concurrency background processors.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 sm:px-12 py-12 bg-white">
        <div className="w-full max-w-[420px] flex flex-col">
          ...
          <h3 className="text-2xl font-bold text-text-dark">Create Account</h3>
          <p className="text-sm text-text-muted mt-2">Get started with your free operator workspace</p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
            ...
            {success && (
              <div className="rounded-lg bg-emerald-50 border border-emerald-200 p-4 text-xs font-semibold text-emerald-600">
                {success}
              </div>
            )}
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="username" className="text-[11px] font-bold text-text-dark uppercase tracking-wider">
                Username
              </label>
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-border pl-11 pr-4 py-2.5 text-sm text-text-dark bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal/30 focus:border-teal transition-all"
                />
                <User className="absolute left-4 top-3.5 h-4.5 w-4.5 text-text-muted" />
              </div>
            </div>

            {/* Email Input */}
            <div className="flex flex-col gap-1">
              <label htmlFor="email" className="text-[11px] font-bold text-text-dark uppercase tracking-wider">
                Email Address
              </label>
              <div className="relative">
                <input
                  ...
                  placeholder="operator@sentix.ai"
                  className="w-full rounded-lg border border-gray-border pl-11 pr-4 py-2.5 text-sm text-text-dark bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal/30 focus:border-teal transition-all"
                />
                <Mail className="absolute left-4 top-3.5 h-4.5 w-4.5 text-text-muted" />
              </div>
            </div>

            {/* Password Input */}
            <div className="flex flex-col gap-1">
              <label htmlFor="password" className="text-[11px] font-bold text-text-dark uppercase tracking-wider">
                Password
              </label>
              <div className="relative">
                <input
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="confirmPassword" className="text-[11px] font-bold text-text-dark uppercase tracking-wider">
                Confirm Password
              </label>
              <div className="relative">
                <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 bg-teal hover:bg-teal-dark text-white font-semibold py-3 rounded-lg shadow-md hover:shadow-teal/20 transition-all flex items-center justify-center disabled:opacity-50"
            >
              {loading ? (
            ...
            <button
              ...
              className="mt-2 w-full flex items-center justify-center gap-2 border border-gray-border hover:bg-gray-50 text-text-dark font-semibold py-3 rounded-lg text-sm transition-all"
            >
